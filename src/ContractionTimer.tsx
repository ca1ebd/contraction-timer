...
export default function ContractionTimer() {
  ...
  if (!loaded) {
    return <div className="min-h-dvh" style={{ background: T.backdrop }} />;
  }

  return (
    <div
      className="min-h-dvh flex flex-col md:items-center md:justify-center md:p-8"
      style={{ background: T.backdrop }}
    >
      <style>{css}</style>

      <div className="w-full md:max-w-[1200px] flex md:items-center md:justify-center">
        <div
          className="ct-root w-full flex flex-col select-none md:max-w-[560px] md:h-[min(880px,calc(100dvh-4rem))] md:rounded-[28px] md:border md:shadow-2xl md:overflow-hidden"
          style={{
